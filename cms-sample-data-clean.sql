-- Clean insert of sample data (run this instead of cms-sample-data.sql)
...
-- Delete existing page sections to avoid duplicates
DELETE FROM page_sections WHERE page_id IN (SELECT id FROM pages WHERE slug IN ('home', 'case-studies'));
